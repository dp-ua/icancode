...
public class ElementSleepMachine extends DomainElement implements EJump, EBlockLaser {
    private final Logger log = Logger.getLogger(ElementSleepMachine.class);

    public ElementSleepMachine(int x, int y) {
        super(x, y);
    }

    public ElementSleepMachine(int x, int y, Direction attackDirection) {
